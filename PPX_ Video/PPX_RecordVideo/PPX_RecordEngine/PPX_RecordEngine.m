...
#import "PPX_RecordEncoder.h"
#import <AVFoundation/AVFoundation.h>
#import <Photos/Photos.h>



@interface PPX_RecordEngine ()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate> {
...
@property (strong, nonatomic) PPX_RecordEncoder           *recordEncoder;//录制编码
...
@implementation PPX_RecordEngine
...
- (void) captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    ...
    @synchronized(self) {
        ...
        if ((self.recordEncoder == nil) && !isVideo) {
            ...
            self.recordEncoder = [PPX_RecordEncoder encoderForPath:self.videoPath Height:_cy width:_cx channels:_channels samples:_samplerate];
        }
        //判断是否中断录制过
        if (self.discont) {
            if (isVideo) {
